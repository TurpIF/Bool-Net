/*!
 * \file include/dynamic/matrix_model.h
 ...
 */
#ifndef __DYNAMIC_MATRIX_MODEL_H__
#define __DYNAMIC_MATRIX_MODEL_H__

#include <cstddef>
#include <cstdlib>

#include "dynamic/abstract_model.h"
...
namespace dynamic
{
        ...
        class matrix_model : public abstract_model<Size>
    {
        public:
             ...
             */
            static const std::size_t size = abstract_model<Size>::size;
