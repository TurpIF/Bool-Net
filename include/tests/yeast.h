#ifndef __TESTS_YEAST_H__
#define __TESTS_YEAST_H__

#include <ctime>
#include <cstddef>

#include "dynamic/timed_matrix_model.h"
#include "models/yeast.h"

namespace tests
{
    class yeast : public dynamic::matrix_model<12, dynamic::timed_coef>, public models::yeast
    {
        public:
